...
$TIME_APPLICATION/time -p -o $HCCP_EXECUTION_TIME_CP.$LOCAL_INSTANCE cp $LOCAL_SOURCE $LOCAL_DESTINATION
$TIME_APPLICATION/time -p -o $HCCP_EXECUTION_TIME_SYNC.$LOCAL_INSTANCE sync
