...
LOCAL_CLOCK_DOMAINS=(WKUP_L4_ICLK2 WKUP_32K_GFCLK GPT1_FCLK GPT12_FCLK \
		     SECURE_32K_CLK FUNC_32K_CLK L4_ICLK2 USIM_FCLK CORE_DPLL_EMU_CLK \
		     MPU_DPLL_CLK AESS_FCLK DMIC_ABE_FCLK ABE_ICLK2 MCASP1_FCLK \
		     MCBSP1_FCLK MCBSP2_FCLK MCBSP3_FCLK PAD_CLKS SLIMBUS_UCLKS \
		     ABE_GPT5_FCLK ABE_GPT6_FCLK ABE_GPT7_FCLK ABE_GPT8_FCLK \
		     ABE_ALWON_32K_CLK IVAHD_ROOT_CLK DSP_ROOT_CLK SR_CORE_SYS_CLK \
		     SR_MPU_SYS_CLK SR_IVA_SYS_CLK CFG_L4_ICLK C2C_L3X2_ICLK \
		     C2C_L3_ICLK C2C_L4_ICLK DMA_L3_ICLK MPU_M3_CLK L3_ICLK1 \
		     L3_ICLK2 L3_INSTR_GICLK EMIF_L3_ICLK DLL_CLK STD_EFUSE_SYS_CLK \
		     CUST_EFUSE_SYS_CLK ISS_CLK FDIF_FCLK DSS_FCLK HDMI_PHY_48M_FCLK \
		     SGX_FCLK HSI_FCLK MMC1_FCLK MMC2_FCLK INIT_48MC_FCLK OTG_60M_FCLK \
		     INIT_48M_FCLK INIT_60M_FCLK L3_SECURE_GICLK L3_SECURE_GICLK \
		     SLIMBUS_CORE_UCLKS PER_48M_FCLK PER_L4_ICLK 12M_FCLK PER_MCBSP4_FCLK)
