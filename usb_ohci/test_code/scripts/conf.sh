...
export EHCI_LEVEL=/sys/devices/platform/ehci-omap.0/usb1/power/level
...
##Device
#export REMOTE_PATH=/home/x0055901/test
...
##Device
###File storage gadget
export VFAT_FILE=${MISC_PATH}/vfat-4M_12xand18x
