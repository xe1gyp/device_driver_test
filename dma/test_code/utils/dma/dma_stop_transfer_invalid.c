...
static int __init dma_module_init(void) {
	...
	printk(KERN_INFO "Stopping invalid transfer id %d before completion\n",
	 transfers[1].transfer_id); stop_dma_transfer_invalid(&transfers[1]);
