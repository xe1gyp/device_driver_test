 ...
 *
 * The following testcode checks that the double index addressing mode
...
#define PROC_FILE "driver/dma_addrmode_doubleidx"
...
static int __init dma_module_init(void) {
       ...
       for(i = 0; i < TRANSFER_COUNT; i++){
           ...
           transfers[i].addressing_mode = OMAP_DMA_AMODE_DOUBLE_IDX;
