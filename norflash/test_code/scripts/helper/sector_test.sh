...
SECTORSIZE_TWO=$(( $SECTORSIZE_ONE*2|bc ))
SECTORSIZE_THREE=$(( $SECTORSIZE_ONE*3|bc ))
SECTORSIZE_FOUR=$(( $SECTORSIZE_ONE*4|bc ))
#Sector Size
SECTORSIZE=`hexConvert "$SECTORSIZE_ONE"`
SECTORSIZE2=`hexConvert "$SECTORSIZE_TWO"`
#Sector Size -1
SECTORSIZE_1=`hexConvert "$SECTORSIZE_ONE-1|bc"`
SECTORSIZE_2=`hexConvert "$SECTORSIZE_ONE-2|bc"`
SECTORSIZE2_1=`hexConvert "$SECTORSIZE_TWO-1|bc"`
SECTORSIZE2_2=`hexConvert "$SECTORSIZE_TWO-2|bc"`
#Sector Size +1
SECTORSIZE_P=`hexConvert "$SECTORSIZE_ONE+1|bc"`
SECTORSIZE_P2=`hexConvert "$SECTORSIZE_ONE+2|bc"`
SECTORSIZE2_P=`hexConvert "$SECTORSIZE_TWO+1|bc"`
SECTORSIZE2_P2=`hexConvert "$SECTORSIZE_TWO+2|bc"`

# Test Sectors
TEST_X=`hexConvert "$SECTORSIZE_ONE "`
TEST_X_1=`hexConvert "$SECTORSIZE_ONE-1|bc"`
TEST_X_P=`hexConvert "$SECTORSIZE_ONE+1|bc"`
TEST_Y=`hexConvert "$SECTORSIZE_TWO"`
TEST_Y_1=`hexConvert "$SECTORSIZE_TWO-1|bc"`
TEST_Y_P=`hexConvert "$SECTORSIZE_TWO+1|bc"`
TEST_YD=`hexConvert "$SECTORSIZE_THREE"`
TEST_YD_1=`hexConvert "$SECTORSIZE_THREE-1|bc"`
TEST_YD_P=`hexConvert "$SECTORSIZE_THREE+1|bc"`
TEST_YP=`hexConvert "$SECTORSIZE_FOUR"`
TEST_YP_1=`hexConvert "$SECTORSIZE_FOUR-1|bc"`
TEST_YP_P=`hexConvert "$SECTORSIZE_FOUR+1|bc"`
